...
export default {
  ...
  methods: {
    ...
    sendData() {
      ...
      axios
        .post(
          `https://appinventory.shuvobhowmik.xyz/api/return-sales/${this.$route.params.id}`,
          data,
          {
            headers: {
              "Content-Type": "application/json",
      ...
      <div class="page-content">
        ...
        >
          <router-link to="/sales"
            ><h6 class="mb-0 text-uppercase">Return Sales</h6></router-link
          >
