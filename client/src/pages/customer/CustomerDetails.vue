...
export default {
  ...
  methods: {
    ...
    getCustomer(customerId) {
      ...
      console.log(token);
      axios
        .get(`https://appinventory.shuvobhowmik.xyz/api/customer-details/${customerId}`, {
          headers: {
        ...
        .then((response) => {
          ...
          this.loading = false;
          this.customerData = response.data.customer_data;
          this.saleData = response.data.sale_data;
        ...
        <div class="page-content">
          <div>
            ...
            >
              ...
              <div class="ms-auto">
                <div class="btn-group">
                  <router-link to="/customer" type="button" class="btn btn-primary">
                    Go Back
                  </router-link>
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table mb-0 table-dark table-striped mt-5">
                          ...
                          <tbody>
                            <tr
                              v-for="(item, index) in this.saleData"
                              :key="index"
                            >
